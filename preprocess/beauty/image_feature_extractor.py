...
def extract_raw_feature(config, device='cuda', batch_size=218, image_dir=''):
    ...
    features_array, image_paths = extract_raw_image_feature(config, device, batch_size, image_dir) # from utils.py
...
if __name__=='__main__':
    ...
    features_array, image_path_list = extract_raw_feature(config, device, batch_size=218, image_dir=config['data_root']+'image/')

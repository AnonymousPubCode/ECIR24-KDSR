...
def extract_text_feature(config, title_corpus, asin_list, tokenizer, batch_size=64):
...
if __name__=='__main__':
    ...
    # encode sentences
    features_array = extract_text_feature(config, title_corpus, asin_list, tokenizer, batch_size=8)
